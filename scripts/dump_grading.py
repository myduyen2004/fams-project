...
def dump_diagram(file_path):
    try:
        ...
        # Draw.io files can have different structures. We look for mxCell.
        ...
        for cell in cells:
            ...
            if 'swimlane' in style:
                ...
                # Find children (fields and methods)
                for item in cells:
...
if __name__ == "__main__":
    dump_diagram('../docs/grading_assessment_class_diagram.drawio')
