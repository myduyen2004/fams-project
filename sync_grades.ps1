# FAMS - Grades Data Sync Script
# PowerShell script to generate and import real grades data

Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "   FAMS GRADES DATA GENERATOR & SYNC" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan

# 1. Chạy script Python để sinh file SQL dựa trên Enrollments và Grade Components
Write-Host "[1/2] Running Python script to generate SQL..." -ForegroundColor Yellow
python backend/scripts/generate_grades_data.py
...
$SqlFile = "insert_real_grades.sql"
