    ...
    const handlePreview = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.data.canImport) {
                ...
                toast.error(`Có ${response.data.errorRows} lỗi. Vui lòng sửa file và thử lại.`);
            }
        } catch (error: unknown) {
                    ...
                    {!previewResult && !importResult && (
                        <form onSubmit={handlePreview} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full h-[44px] border-2 border-fpt-orange/20 rounded-2xl text-sm font-bold text-fpt-orange bg-orange-50/50 hover:bg-orange-50 transition-all flex items-center justify-center gap-2"
                            >
