...
import { Major, MajorCreateRequest, MajorSearchParams } from '../../types/major';
...
export const majorService = {
    ...
    importMajors: async (file: File): Promise<Major[]> => {
        const formData = new FormData();
        formData.append('file', file);
        const response = await axios.post(`${API_URL}/majors/import`, formData, {
            headers: {
                ...getAuthHeader(),
