...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
        ...
        Page<ChatMessage> findByChatGroupIdOrderBySentAtDesc(Long chatGroupId, Pageable pageable);

        @EntityGraph(attributePaths = {"sender"})
        Page<ChatMessage> findByChatGroupIdOrderBySentAtAsc(Long chatGroupId, Pageable pageable);
