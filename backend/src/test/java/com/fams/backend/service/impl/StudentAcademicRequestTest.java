...
public class StudentAcademicRequestTest {
        ...
        void setUp() {
                ...
                semester.setStartDate(LocalDate.now().plusWeeks(6)); // Setting to 6 weeks ahead ensures 'now' is within
                                                                     // [start,
        ...
        class CreateRequestTests {
                ...
                void createRequest_Success() {
                        ...
                        when(semesterRepository.findUpcomingSemesters())
                                        .thenReturn(java.util.Collections.singletonList(semester));
                ...
                void createRequest_DuplicatePending() {
                        ...
                        BadRequestException exception = assertThrows(BadRequestException.class,
                                        () -> academicRequestService.createRequest(createDTO, null, 1L));
                        assertEquals("You already have a pending request of this type for this semester",
